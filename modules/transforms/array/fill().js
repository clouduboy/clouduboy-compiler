// myArray.fill(42)
// >>>
// for (int _a_fill_idx_ = 0; _a_fill_idx_ < sizeof(my_array); ++_a_fill_idx_) my_array[_a_fill_idx_] = 42;
...
module.exports = (context) => {
  ...
  return `for (unsigned int _a_fill_idx_ = 0; _a_fill_idx_ < sizeof( ${varName} ); ++_a_fill_idx_) ${varName}[_a_fill_idx_] = ${translate(callexp.arguments[0])}`
  ...
  //return `memset(${varName}, ${translate(callexp.arguments[0])}, sizeof(${varName}))`
}
