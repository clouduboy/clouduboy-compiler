boolean collides(
  ${targetPlatform.mappings.graphics.ctype}* s1, int x1,int y1, int s1_width, int s1_height,
  ${targetPlatform.mappings.graphics.ctype}* s2, int x2,int y2, int s2_width, int s2_height,
  boolean precise
) {
